...
class Net1(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        super().__init__()
        self.conv1 = LRConvI2F2d(in_channels, 2, 3, padding=1)
        self.conv2 = LRConvF2F2d(2, 4, 3, padding=1)
        self.conv3 = LRConvF2F2d(4, 8, 3, padding=1)
...
class Net2(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        super().__init__()
        self.conv1 = torch.nn.Conv2d(in_channels, 4, 3, padding=1)
